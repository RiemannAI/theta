            ...
            if len(value):
                ...
                for k in range(num_vectors):
                    ...
                    finite_sum_with_derivatives(real, imag,
                                                &X[0,0], &Yinv[0,0], &T[0,0],
                                                &x[0], &y[0], &S[0,0],
                                                &derivs_real[0], &derivs_imag[0],nderivs, g, N)
                    value = numpy.complex(real[0] + 1.0j*imag[0])
                    values[k] = value
    ...
    if isinstance(derivs, list):
        ...
        if len(derivs):
            ...
            for k in range(num_vectors):
                ...
                values_nom[k] = numpy.complex(real[0] + 1.0j*imag[0])

                finite_sum_without_derivatives(real, imag,
                                               &X[0,0],&Yinv[0,0], &T[0,0], &x[0], &y[0], &S[0,0],g, N)

                values_den[k] = numpy.complex(real[0] + 1.0j*imag[0])
